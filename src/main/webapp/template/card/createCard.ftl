...
<html>
 ...
 <body>
  <form name="queryform" namespace="/card" action="createCard.act" >
  <div class="right_box">
  	<div id="div">
  		<!--ul class="fix">
  		...
  		<ul class="fix" style="margin-top:0px;">
  			...
  			<li class="sl">&nbsp;</li>
  			<li class="sl">
  				有效期： <input type="text" name="endTime" id="endTime" class="Wdate required date ipb_m" type="text"   onclick="WdatePicker({startDate: '%y-%M-%d 23:59:59',dateFmt:'yyyy-MM-dd HH:mm:ss'})"  value="${endTime!''}"/>
  			</li>
