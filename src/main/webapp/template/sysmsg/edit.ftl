...
<h2 style="margin:20px 0 0 30px;">编辑系统公告</h2>
<form action="${rc.contextPath}/sysMsg/editSysMsg.act" name="inputform" method="post">
<input type="hidden" name="id" value="${sysMsg.id}"> 
<ul class="fix">
<li class="nl label">标题</li>
<li class="sl"><input type="text" name="title" class="required ipb_m" style="width:300px" value='${sysMsg.title!""}'/></li>
<li class="nl label">内容</li>
<li class="sl"><textarea name='msg' id='msg' rows='5' cols='50' class="required" maxlength='50'>${sysMsg.msg!""}</textarea></li>
